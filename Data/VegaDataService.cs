...
namespace Vega_LiteBlazor.Data
{
    public class VegaDataService
    {
        ...
        //}
        //}
        public Task<VegaData[]> GetVegaDataAsync(DateTime startDate)
        {
            var rng = new Random();
            return Task.FromResult(Enumerable.Range(1, 10).Select(index => new VegaData
            {
                a = startDate.AddMinutes(index).ToLocalTime(),
                b = rng.Next(-20, 55)
